...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'forest-point':
				var bg:BGSprite = new BGSprite('point-forest', -370, -450, 0.9, 1);
				add(bg);
		}
		...
		switch(Paths.formatToSongPath(SONG.song))
		{
			...
			case 'showdown-at-the-point':
				GameOverSubstate.characterName = 'pocyk-bfts';
				GameOverSubstate.deathSoundName = 'fnf_loss_sfx-Steklobaba';
				skipCountdown = true;
		}
